...
<head>
    ...
    <!-- Document Title
    ============================================= -->
	<title>Archakaas | Features</title>
                ...
                <div class="container clearfix">
                  ...
                  <nav id="primary-menu">
                        ...
                        <ul>
                            ...
                            <li class="current"><a href="features.php"><div>Features</div></a>
                                
                            </li>
                            <li class="mega-menu"><a href="prayers-club.php"><div>Prayer Club</div></a>
                                
                            </li>
                            <li class="mega-menu"><a href="global-temples.php"><div>Global Temples</div></a>
                                
                            </li>
                            
                            <li><a href="testimonials.php"><div>Testimonials</div></a>
                            </li>
        ...
        <section id="content">
            ...
            <div class="content-wrap">
                ...
                <div class="container clearfix">
                    ...
                    <div class="col_one_third nobottommargin">
                        ...
                        <h3>"शर्वे जना सुकिनो बवन्थु."</h3>

                        <ul class="iconlist nobottommargin">
                            <li><i class=""></i><a href="#"></a>
                                <ul>
                                    <li><i class=""></i><a href="#"><div>சர்வதேவாத பிரதிஷ்டை விதிகள்</div></a></li>
                                    <li><i class=""></i><a href="#"><div>உற்ச்சவ விதிகள்</div></a></li>
                                    <li><i class=""></i><a href="#"><div>பிராயச்சித்தவிதி</div></a></li>
                                    <li><i class=""></i><a href="#"><div>தீட்க்ஷாவிதீ</div></a></li>
                                    <li><i class=""></i><a href="#"><div>அபரகிரியை மற்றும் சர்வதேவதா காயத்ரீ மந்திரங்கள்</div></a></li>
                                    <li><i class=""></i><a href="#"><div>மூல / மாலா மந்திரங்கள்</div></a></li>
                                    <li><i class=""></i><a href="#"><div>தியானங்கள்</div></a></li>
                                    <li><i class=""></i><a href="#"><div>அஷ்டோதிரங்கள்</div></a></li>
                                    <li><i class=""></i><a href="#"><div>சஹஸ்ரநாமங்கள்</div></a></li>
                                    <li><i class=""></i><a href="#"><div>மேலும் கணபதி முதல் சந்டிஹோமம் வரை உள்ள பூஜா விதிகள் 
</div></a></li>
                                    <li><i class=""></i><a href="#"><div>இன்னும் பல</div></a></li>
                                    <li><i class=""></i><a href="#"><div>மனு / ரவி சூத்ர யாக சாலா விதிகள்</div></a></li>
                                    <li><i class=""></i><a href="#"><div>குண்டவிதானங்கள்</div></a></li>
                                    <li><i class=""></i><a href="#"><div>முத்ரா விதிகள் போன்றவைகளும் இதில் அடங்கும்</div></a></li>
            ...
            <div class="container clearfix">
                    ...
                    <div id="section-globalTemples" class="heading-block title-center page-section">
                        <h2></h2>
                        <span>மேற்கண்டவைகள் அனைத்தும் செய்முறை விளக்கங்கள் தமிழிலும்  மந்திரங்கள் கிரந்தத்திலும் உருவாக்கப்பட்டிருக்கும்</span>
                    </div>
            </div>        
                        ...
                        <div class="col_one_third">
                            ...
                            <div class="widget widget_links clearfix">
                                ...
                                <ul>
                                    ...
                                    <li><a href="prayers-club.php">Prayers Club</a></li>
                                    <li><a href="global-temples.php">Global Temples</a></li>
