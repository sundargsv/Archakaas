			...
			<div class="content-wrap">
				...
				<div class="container center clearfix">
					...
					<div class="heading-block center">
						<h1>We are not happy that you are leaving us</h1><img src="https://cdn1.iconfinder.com/data/icons/emoticons-8/24/Crying-512.png" width="35" height="35">
						<span>Are you sure you want to deactivate your Archakaas Account ?</span>
					</div>

					<p>Comment about your reason and we'll try to fix it.
					</p>
					<div class="accordion accordion-lg divcenter nobottommargin clearfix" style="max-width: 550px;">
						<form id="register-form" name="register-form" class="nobottommargin center" action="#" method="post">
	                          <div class="col_full nobottommargin" style="margin-top:20px;">
	                                                <button class="btn btn-lg btn-danger btn-block nomargin" value="submit" type="submit">Yes I'm Sure&nbsp;<span class="fa fa-check"></span></button>
	                           </div>                      
						</form>
					</div>
				</div>
