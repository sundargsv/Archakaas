			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					<div id="logo" class="divcenter">
						<a href="home-page.php" class="standard-logo" data-dark-logo="http://canvashtml-cdn.semicolonweb.com/images/logo-dark.png"><img class="divcenter" src="http://canvashtml-cdn.semicolonweb.com/images/logo.png" alt="Canvas Logo"></a>
						<a href="home-page.php" class="retina-logo" data-dark-logo="http://canvashtml-cdn.semicolonweb.com/images/logo-dark@2x.png"><img class="divcenter" src="http://canvashtml-cdn.semicolonweb.com/images/logo@2x.png" alt="Canvas Logo"></a>
				</div><!-- #logo end -->
				...
				<div class="container clearfix">
					...
					<script>
						jQuery(document).ready( function($){
							var newDate = new Date(2015, 10, 31);
