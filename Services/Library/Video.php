                    ...
                    <ul>
                       ...
                       <li><a href="#"><div>Veda Mantras</div></a>
                          <ul>
                            ...
                            <li class="current"><a href="Gallery.php"><div>Library</div></a>
                                <ul>
					...
					<div class="sidebar nobottommargin col_last clearfix">
						<div class="sidebar-widgets-wrap">
							...
							<div class="widget widget_links clearfix">
								...
								<h4>Choose Video</h4>
								<ul>
									<li><a href="#tab1"><div><span class="glyphicon glyphicon-arrow-right"></span>சஹஸ்ரநாம ஸ்தோத்திரம்</div></a></li>

									<li><a href="#tab2"><div><span class="glyphicon glyphicon-arrow-right"></span>அஷ்டோத்தர சதநாம ஸ்தோத்திரம்</div></a></li>

									<li><a href="#tab3"><div><span class="glyphicon glyphicon-arrow-right"></span>அஷ்டோத்தர சதநாமாவளி</div></a></li>

									<li><a href="#tab4"><div><span class="glyphicon glyphicon-arrow-right"></span>சஹஸ்ரநாமாவளி</div></a></li>

									<li><a href="#tab5"><div><span class="glyphicon glyphicon-arrow-right"></span>மூல மந்திரங்கள்</div></a></li>

									<li><a href="#tab6"><div><span class="glyphicon glyphicon-arrow-right"></span>மாலா மந்திரங்கள்</div></a></li>

									<li><a href="#tab7"><div><span class="glyphicon glyphicon-arrow-right"></span>ஸ்தோத்திரங்கள்</div></a></li>

									<li><a href="#tab8"><div><span class="glyphicon glyphicon-arrow-right"></span>தியானங்கள்</div></a></li>

									<li><a href="#tab9"><div><span class="glyphicon glyphicon-arrow-right"></span>நியாசங்கள்</div></a></li>
								</ul>
